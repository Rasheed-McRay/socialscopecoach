...
export function AnalysisCard({ title, date, tone, toneEmoji, onClick }: AnalysisCardProps) {
  return (
    ...
    >
      {/* Outer glow on hover */}
      <div className="absolute inset-0 rounded-2xl opacity-0 group-hover:opacity-100 transition-opacity duration-300 blur-lg bg-primary/15" />
      
      {/* Card content */}
      <div className="relative bg-gradient-to-br from-card via-card to-background/80 rounded-[15px] p-4 shadow-card">
