...
// Daily scope prompts
const DAILY_PROMPTS = ["What type of animal are you?", "Describe your perfect weekend.", "If you could have dinner with anyone, who would it be?", "What's your most unpopular opinion?", "Describe yourself in three words.", "What's the best advice you've ever received?", "If you won the lottery, what's the first thing you'd do?"];
        ...
        <main className="px-4 md:px-8 py-6 md:py-10 space-y-6 max-w-4xl mx-auto">
          ...
          animationDelay: "0.1s"
            ...
            <div className="rounded-2xl bg-card border border-primary/20 p-5 md:p-6 text-center space-y-1 transition-all duration-200 hover:border-primary/40 hover:shadow-[0_0_20px_rgba(247,165,58,0.1)]">
              ...
              <p className="text-muted-foreground md:text-base text-lg">
                {getDailyPrompt()}
              </p>
            </div>
          </section>
