...
const DAILY_PROMPTS = [
  ...
  "Describe a small act you witnessed that restored your faith in people.",
  "What's a part of your daily life that future generations might find strange?",
  "Tell me about a time you trusted a feeling you couldn't fully explain.",
  "If you could remove one type of noise from your life, what would it be?",
  "Describe a person who taught you something without ever trying to.",
  "What's a way you'd like to be challenged this year?",
  "Tell me about a moment you stopped performing and just existed.",
  "How do you decide whose opinions actually deserve weight in your life?",
  "Describe a part of yourself that only certain people get to see.",
  "What's something you've been told you're 'too much' about that you've decided to keep?",
  "Tell me about a time you chose long-term peace over short-term pleasure.",
  "If you could give a younger version of yourself one object, what would it be?",
  "Describe what it feels like to forgive — not the act, the aftermath.",
  "What's a way you've made yourself proud lately, even quietly?",
  "Tell me about a conversation that's still teaching you something years later.",
  "How has the way you ask for help changed over time?",
  "Describe a place where you feel most like the truest version of yourself.",
  "What's something you used to outsource that you've finally learned to do for yourself?",
  "Tell me about a moment when an old wound suddenly felt lighter.",
  "If you had to choose one phrase to live by for the next year, what would it be?",
  "Describe a way the people who raised you still show up in your reflexes.",
  "What's a piece of your life you're slowly rebuilding on your own terms?",
  "Tell me about a stranger's kindness you still think about.",
  "How do you tell the difference between a season ending and something failing?",
  "Describe a moment your body knew before your mind did.",
  "What's something you used to think was weakness that you now see as strength?",
  "Tell me about a quiet promise you've made to yourself.",
  "If today were a chapter title in the story of your life, what would it be called?",
];
